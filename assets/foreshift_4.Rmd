...
- **Renewable within a limit** (`ifelse(.demand < 60, (- 1*.production_fixed), NA)`): The grid cap can be included directly in the formula. In this case, whenever the total demand exceeds `60`, a point is disallowed to keep receiving demand.
