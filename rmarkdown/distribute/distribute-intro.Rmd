...
`distribute()` shares according with a number of parameters a given amount of energy or power among consumers. It is a relatively lower-level function, and unlike `foreshift()` or `backshift()`, it is not designed to be used in conjunction with an `e_frame` object.
