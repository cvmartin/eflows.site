There is a limitless combination of potential formulas to apply. Among them, there are several predefined:
...
- **Profit within a limit** (`ifelse(.demand < 60, .price, .demand)`): The grid cap can be included directly in the formula. In this case, whenever the total demand exceeds `60`, a point is disallowed to keep receiving demand.
