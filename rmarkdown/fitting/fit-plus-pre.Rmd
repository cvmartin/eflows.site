...
- **Profit within a limit** (`ifelse(.demand < .cap, .price, NA)`): The grid cap can be included directly in the formula. In this case, whenever the total demand exceeds `.cap`, a point is disallowed to keep receiving demand.
