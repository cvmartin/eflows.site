...
In comparison, the *power distribution* approach just requires to decide few parameters, that do not even ned to be associated with the EVs; they could instead depend on the user cards used at charging poles. Hence, this alternative seems more ready for use it in a real-world scenario.
