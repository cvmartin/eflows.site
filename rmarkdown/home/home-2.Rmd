...
- [Foreshift](.#foreshift): A first grasp of `eflows` possibilites and its take on flexible demand.
- [Fitting formula and curve](.#fitting): A comprehensive approach to decide where to allocate this flexible demand. 
- [Electric Vehicles charging](.#ev): A first practical user case that could be used already in production for real-time steering. 
- [Design principles](.#principles): To delve deeper in the architecture and the decission design of `eflows`.
